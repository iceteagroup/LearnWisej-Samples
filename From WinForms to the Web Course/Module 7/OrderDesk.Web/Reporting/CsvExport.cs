...
{
    /// <summary>
    /// The web replacement for "Export to Excel": build the file on the server in memory; the
    /// download guard stores it under the storage root and hands it to the browser. No local path, no Interop.
    /// </summary>
