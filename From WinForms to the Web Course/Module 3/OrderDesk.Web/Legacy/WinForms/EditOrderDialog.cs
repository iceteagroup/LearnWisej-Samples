...
{
    /// <summary>The modal edit dialog: customer, owner, status, PO. Returns DialogResult.OK on Save.</summary>
    public partial class EditOrderDialog : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Select a customer.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);   // ✓ kept modal: the user must fix the input before Save can continue
                return;
            }
