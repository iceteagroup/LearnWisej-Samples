...
namespace ValidationClinic
{
    public partial class CustomerIntakeForm : Form
    {
        ...
        public CustomerIntakeForm(ContactRepository repository, Action<string, string> trace)
        {
            ...
            InitializeComponent();
            SetupValidation();
            dtpBirthDate.Value = model.BirthDate.Value; dtpStart.Value = model.StartDate.Value; dtpEnd.Value = model.EndDate.Value;
        }
        ...
        private ContactEditModel ReadModel()
        {
            ...
            model.BirthDate = dtpBirthDate.Value; model.StartDate = dtpStart.Value; model.EndDate = dtpEnd.Value;
            return model;
        }
