namespace ValidationClinic
{
    partial class MainPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnBindingDemo = new Wisej.Web.Button();
            this.btnSaveGrid = new Wisej.Web.Button();
            this.gridSummaryLabel = new Wisej.Web.Label();
            ...
            this.lblTitle.Text = "ValidationClinic | Module 6 - DataGridView Cell Validation and Row Errors";
            //
            // lblHint
            //
            ...
            this.gridContacts.CellValidating += new Wisej.Web.DataGridViewCellValidatingEventHandler(this.gridContacts_CellValidating);
            this.gridContacts.CellValidated += new Wisej.Web.DataGridViewCellEventHandler(this.gridContacts_CellValidated);
            this.gridContacts.DataError += new Wisej.Web.DataGridViewDataErrorEventHandler(this.gridContacts_DataError);
            this.gridContacts.CellValueChanged += new Wisej.Web.DataGridViewCellEventHandler(this.gridContacts_CellValueChanged);
            //
            // lblTrace
            //
            ...
            // btnBindingDemo
            //
            this.btnBindingDemo.CausesValidation = false;
            this.btnBindingDemo.Location = new System.Drawing.Point(575, 96);
            this.btnBindingDemo.Name = "btnBindingDemo";
            this.btnBindingDemo.Size = new System.Drawing.Size(175, 34);
            this.btnBindingDemo.TabIndex = 5;
            this.btnBindingDemo.Text = "Data-bound errors";
            this.btnBindingDemo.Click += new System.EventHandler(this.btnBindingDemo_Click);
            //
            // btnSaveGrid
            //
            this.btnSaveGrid.CausesValidation = false;
            this.btnSaveGrid.Location = new System.Drawing.Point(20, 644);
            this.btnSaveGrid.Name = "btnSaveGrid";
            this.btnSaveGrid.Size = new System.Drawing.Size(155, 34);
            this.btnSaveGrid.TabIndex = 6;
            this.btnSaveGrid.Text = "Save grid";
            this.btnSaveGrid.Click += new System.EventHandler(this.btnSaveGrid_Click);
            //
            // gridSummaryLabel
            //
            this.gridSummaryLabel.AutoSize = false;
            this.gridSummaryLabel.Location = new System.Drawing.Point(20, 685);
            this.gridSummaryLabel.Name = "gridSummaryLabel";
            this.gridSummaryLabel.Size = new System.Drawing.Size(1260, 110);
            this.gridSummaryLabel.Text = "";
            //
            // NameColumn
            //
            ...
            this.Controls.Add(this.btnBindingDemo);
            this.Controls.Add(this.btnSaveGrid);
            this.Controls.Add(this.gridSummaryLabel);
            this.Name = "MainPage";
        ...
        private Wisej.Web.Button btnBindingDemo;
        private Wisej.Web.Button btnSaveGrid;
        private Wisej.Web.Label gridSummaryLabel;
