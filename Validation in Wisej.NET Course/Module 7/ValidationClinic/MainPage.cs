    ...
    public partial class MainPage : Page
    {
        ...
        private void Reload()
        {
            ...
            try
            {
                ...
                gridSummaryLabel.Text = ""; gridSummaryLabel.Visible = false;
            }
        ...
        {
            var form = new CustomerIntakeForm(repository, Trace, ValidateGrid, () => workingRows.ToList());
        ...
        private void gridContacts_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            if (reloading || e.RowIndex < 0 || e.RowIndex >= gridContacts.Rows.Count)
                return;
