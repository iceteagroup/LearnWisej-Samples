namespace SupportDesk.Web
{
    partial class TicketBrowserPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.SuspendLayout();
            //
            // panelBrowser  (the ticket browser card — the Module 3 lab)
            //
            ...
            this.labelLead.Text = "Module 3 · the ticket browser. Filters, order and page are composed on one IQueryable and executed twice — a COUNT and a projected, paged SELECT — and the materialised List<TicketListItem> is handed to ticketBindingSource. The grid binds to the BindingSource, never to a DbSet.";
            ...
            //
            // panelActions  (bottom bar, row 1: the Module 3 paths)
            //
            this.panelActions.Controls.Add(this.labelActions1);
            ...
            this.panelActions.Controls.Add(this.buttonBindQuery);
            ...
            this.buttonBreak.ToolTipText = "Turns the development outage switch on and searches: the catch shows a friendly message, finally re-enables Search.";
            ...
            this.buttonRestore.ToolTipText = "Turns the switch off. The next search gets a fresh context from the factory — nothing failed is reused.";
            ...
            //
            // panelActions2  (bottom bar, row 2: the Module 2 paths)
            //
            this.panelActions2.Controls.Add(this.labelActions2);
            this.panelActions2.Controls.Add(this.btnSeed);
            this.panelActions2.Controls.Add(this.buttonReset);
            this.panelActions2.Controls.Add(this.buttonOverlongTitle);
            this.panelActions2.Controls.Add(this.buttonDeleteCustomer);
            this.panelActions2.Controls.Add(this.buttonDeleteAgent);
            this.panelActions2.Controls.Add(this.buttonDeleteTicket);
            ...
            //
            // panelActions3  (bottom bar, row 3: the Module 1 paths)
            //
            this.panelActions3.Controls.Add(this.labelActions3);
            this.panelActions3.Controls.Add(this.countButton);
            this.panelActions3.Controls.Add(this.buttonSlowCount);
            this.panelActions3.Controls.Add(this.buttonRapid);
            this.panelActions3.Controls.Add(this.buttonAntiPattern);
            ...
            this.Size = new System.Drawing.Size(1700, 1130);
            this.Text = "Support Desk Data Console — Module 3";
