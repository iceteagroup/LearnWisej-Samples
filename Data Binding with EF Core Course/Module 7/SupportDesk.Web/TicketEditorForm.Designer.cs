...
namespace SupportDesk.Web
{
    partial class TicketEditorForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnLabSimulateChange = new Wisej.Web.Button();
            ...
            this.btnDelete.Location = new System.Drawing.Point(24, 518);
            ...
            //
            // btnLabSimulateChange  (Module 7 lab prop: the "other operator" acts while THIS editor is open —
            // the page-level Simulate button cannot be clicked while a modal editor is showing)
            //
            this.btnLabSimulateChange.Location = new System.Drawing.Point(142, 518);
            this.btnLabSimulateChange.Name = "btnLabSimulateChange";
            this.btnLabSimulateChange.Size = new System.Drawing.Size(196, 36);
            this.btnLabSimulateChange.Text = "Lab: other operator changes it";
            this.btnLabSimulateChange.ToolTipText = "Updates this ticket through a separate DbContext (Status = Closed, Priority = High) while the editor still holds the RowVersion it loaded. Save afterwards to see DbUpdateConcurrencyException and the Conflict dialog.";
            this.btnLabSimulateChange.Visible = false;
            this.btnLabSimulateChange.Click += new System.EventHandler(this.btnLabSimulateChange_Click);
            //
            // btnCancel  (AcceptButton/CancelButton set below — Cancel writes nothing)
            //
            this.btnCancel.Location = new System.Drawing.Point(390, 518);
            ...
            this.Controls.Add(this.btnLabSimulateChange);
        ...
        private Wisej.Web.Button btnLabSimulateChange;
