namespace SupportDesk.Web
{
    partial class TicketBrowserPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelLead.Text = "Module 5 · Validation joins the Module 4 editor. TicketValidator runs DataAnnotations plus the closed/future-due-date rule; ErrorProvider and a summary label show the result; Save stays disabled while the model is invalid; a duplicate ticket number still reaches the database and DbUpdateException becomes one friendly sentence.";
            ...
            //
            // panelActions  (bottom bar, row 1: the Module 5 validation paths — the newest module leads —
            // plus the Break/Restore/Slow-save props every dialog this row opens still needs)
            //
            ...
            //
            // buttonBreak  (failure path — moved to row 1: also breaks Save/Delete inside every dialog this row opens)
            //
            this.buttonBreak.Location = new System.Drawing.Point(1274, 4);
            ...
            //
            // buttonRestore  (recovery — moved to row 1)
            //
            this.buttonRestore.Location = new System.Drawing.Point(1462, 4);
            ...
            //
            // buttonSlowSave  (progress path — moved to row 1: a toggle armed for the next dialog, including the lab demo buttons)
            //
            ...
            //
            // panelActions2  (bottom bar, row 2: the Module 4 editor paths)
            //
            this.panelActions2.Controls.Add(this.labelActions1);
            this.panelActions2.Controls.Add(this.btnAdd);
            this.panelActions2.Controls.Add(this.btnEdit);
            ...
            //
            // panelActions3  (bottom bar, row 3: the Module 3 browser paths)
            //
            ...
            this.panelActions5.Location = new System.Drawing.Point(30, 1162);
            ...
            this.Size = new System.Drawing.Size(2040, 1250);
            this.Text = "Support Desk Data Console — Module 5";
