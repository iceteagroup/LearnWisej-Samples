namespace SupportDesk.Web
{
    partial class TicketBrowserPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panelBeforeAfter = new Wisej.Web.Panel();
            this.labelBeforeAfterTitle = new Wisej.Web.Label();
            this.labelBeforeAfter = new Wisej.Web.Label();
            this.labelLongJob = new Wisej.Web.Label();
            this.btnNaiveSearch = new Wisej.Web.Button();
            this.btnOptimisedSearch = new Wisej.Web.Button();
            this.btnCompare = new Wisej.Web.Button();
            this.btnLongJob = new Wisej.Web.Button();
            this.panelBrowser.SuspendLayout();
            this.panelTrace.SuspendLayout();
            this.panelBeforeAfter.SuspendLayout();
            ...
            this.labelLead.Text = "Module 6 · Async loads, related data, filtering and performance. Run naive search issues one statement per row read (tracked, no paging); Run optimised search stays at two (no-tracking, projected, paged in SQL) — Compare runs both and the Before / after card shows the numbers.";
            ...
            //
            // panelBeforeAfter  (Module 6 — the "Before / after" card: last measurement of each branch,
            // left column, under the ticket grid)
            //
            this.panelBeforeAfter.BackColor = System.Drawing.Color.White;
            this.panelBeforeAfter.BorderStyle = Wisej.Web.BorderStyle.Solid;
            this.panelBeforeAfter.Controls.Add(this.labelBeforeAfterTitle);
            this.panelBeforeAfter.Controls.Add(this.labelBeforeAfter);
            this.panelBeforeAfter.Controls.Add(this.labelLongJob);
            this.panelBeforeAfter.Location = new System.Drawing.Point(30, 686);
            this.panelBeforeAfter.Name = "panelBeforeAfter";
            this.panelBeforeAfter.Size = new System.Drawing.Size(940, 200);
            //
            // labelBeforeAfterTitle
            //
            this.labelBeforeAfterTitle.AutoSize = false;
            this.labelBeforeAfterTitle.Font = new System.Drawing.Font("default", 12F, System.Drawing.FontStyle.Bold);
            this.labelBeforeAfterTitle.Location = new System.Drawing.Point(20, 14);
            this.labelBeforeAfterTitle.Name = "labelBeforeAfterTitle";
            this.labelBeforeAfterTitle.Size = new System.Drawing.Size(900, 26);
            this.labelBeforeAfterTitle.Text = "Before / after  ·  the naive branch vs the optimised branch";
            //
            // labelBeforeAfter  (monospace HTML table: statements, database ms, tracked entities, rows, × factor)
            //
            this.labelBeforeAfter.AllowHtml = true;
            this.labelBeforeAfter.AutoSize = false;
            this.labelBeforeAfter.Font = new System.Drawing.Font("monospace", 9F);
            this.labelBeforeAfter.ForeColor = System.Drawing.Color.FromArgb(60, 72, 88);
            this.labelBeforeAfter.Location = new System.Drawing.Point(20, 46);
            this.labelBeforeAfter.Name = "labelBeforeAfter";
            this.labelBeforeAfter.Size = new System.Drawing.Size(900, 120);
            this.labelBeforeAfter.Text = "Run \"Run naive search\" and \"Run optimised search\" (or \"Compare\") to fill this in.";
            this.labelBeforeAfter.TextAlign = System.Drawing.ContentAlignment.TopLeft;
            //
            // labelLongJob  (Module 6 — background job progress, pushed from inside Application.StartTask)
            //
            this.labelLongJob.AutoSize = false;
            this.labelLongJob.Font = new System.Drawing.Font("monospace", 9F);
            this.labelLongJob.ForeColor = System.Drawing.Color.FromArgb(90, 107, 125);
            this.labelLongJob.Location = new System.Drawing.Point(20, 170);
            this.labelLongJob.Name = "labelLongJob";
            this.labelLongJob.Size = new System.Drawing.Size(900, 22);
            this.labelLongJob.Text = "Long job (background): idle";
            this.labelLongJob.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            //
            ...
            this.panelModel.Location = new System.Drawing.Point(30, 906);
            this.panelModel.Name = "panelModel";
            this.panelModel.Size = new System.Drawing.Size(1980, 260);
            //
            // labelModelTitle
            //
            ...
            //
            // panelActions  (bottom bar, row 1: the Module 6 performance paths — the newest module leads —
            // plus Slow search / Break / Restore / Clear trace, since this row's own buttons open the same
            // failure and progress paths)
            //
            this.panelActions.Controls.Add(this.labelActions2);
            this.panelActions.Controls.Add(this.btnNaiveSearch);
            this.panelActions.Controls.Add(this.btnOptimisedSearch);
            this.panelActions.Controls.Add(this.btnCompare);
            this.panelActions.Controls.Add(this.btnLongJob);
            this.panelActions.Controls.Add(this.buttonSlowSearch);
            ...
            this.panelActions.Location = new System.Drawing.Point(30, 1182);
            this.panelActions.Name = "panelActions";
            this.panelActions.Size = new System.Drawing.Size(1980, 44);
            //
            // labelActions2  (reused for row 1 — the newest module's label; Module 3's old text lived here)
            //
            ...
            this.labelActions2.Text = "Module 6 · performance:";
            this.labelActions2.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            //
            // btnNaiveSearch  (Module 6 lab control — the deliberately naive branch)
            //
            this.btnNaiveSearch.Font = new System.Drawing.Font("default", 10F, System.Drawing.FontStyle.Bold);
            this.btnNaiveSearch.Location = new System.Drawing.Point(134, 4);
            this.btnNaiveSearch.Name = "btnNaiveSearch";
            this.btnNaiveSearch.Size = new System.Drawing.Size(170, 36);
            this.btnNaiveSearch.Text = "Run naive search";
            this.btnNaiveSearch.ToolTipText = "TicketQueryService.SearchTicketsNaiveAsync: tracked Tickets, no SQL paging, no projection — one explicit Reference(...).LoadAsync() per row for Customer/Agent/Category, the way CellFormatting would read them under lazy loading. Fills the Before / after card.";
            this.btnNaiveSearch.Click += new System.EventHandler(this.btnNaiveSearch_Click);
            //
            // btnOptimisedSearch  (Module 6 lab control — the existing Module 3 branch, run head to head)
            //
            this.btnOptimisedSearch.Location = new System.Drawing.Point(312, 4);
            this.btnOptimisedSearch.Name = "btnOptimisedSearch";
            this.btnOptimisedSearch.Size = new System.Drawing.Size(190, 36);
            this.btnOptimisedSearch.Text = "Run optimised search";
            this.btnOptimisedSearch.ToolTipText = "TicketQueryService.SearchTicketsAsync: no-tracking projection, filters and paging in SQL, exactly two statements. Fills the Before / after card.";
            this.btnOptimisedSearch.Click += new System.EventHandler(this.btnOptimisedSearch_Click);
            //
            // btnCompare  (Module 6 lab control — both branches, same filters, one after the other)
            //
            this.btnCompare.Location = new System.Drawing.Point(510, 4);
            this.btnCompare.Name = "btnCompare";
            this.btnCompare.Size = new System.Drawing.Size(210, 36);
            this.btnCompare.Text = "Compare (both, same filters)";
            this.btnCompare.ToolTipText = "Runs the naive branch, then the optimised branch, with the same criteria read from the controls above — the Before / after card shows both and the × improvement factor.";
            this.btnCompare.Click += new System.EventHandler(this.btnCompare_Click);
            //
            // btnLongJob  (Module 6 lab control — a report-style background task, its own context)
            //
            this.btnLongJob.Location = new System.Drawing.Point(728, 4);
            this.btnLongJob.Name = "btnLongJob";
            this.btnLongJob.Size = new System.Drawing.Size(200, 36);
            this.btnLongJob.Text = "Long job (background)";
            this.btnLongJob.ToolTipText = "Application.StartTask runs TicketQueryService.CountTicketsPerStatusAsync — its own DbContext, five steps, progress pushed to labelLongJob through Application.Update(this).";
            this.btnLongJob.Click += new System.EventHandler(this.btnLongJob_Click);
            //
            // buttonSlowSearch  (progress path — moved to row 1: the loading guard, next to the two branches it slows down)
            //
            this.buttonSlowSearch.Location = new System.Drawing.Point(936, 4);
            ...
            //
            // buttonBreak  (failure path — row 1 is always the newest module's row; a global switch, position does not change what it affects)
            //
            this.buttonBreak.Location = new System.Drawing.Point(1114, 4);
            this.buttonBreak.Name = "buttonBreak";
            this.buttonBreak.Size = new System.Drawing.Size(180, 36);
            this.buttonBreak.Text = "Break the database";
            this.buttonBreak.ToolTipText = "Turns the development outage switch on. Affects every path on the page, including the editor's Save/Delete — try it, then open Edit and click Save.";
            this.buttonBreak.Click += new System.EventHandler(this.buttonBreak_Click);
            //
            // buttonRestore  (recovery — row 1)
            //
            this.buttonRestore.Location = new System.Drawing.Point(1302, 4);
            ...
            //
            // panelActions2  (bottom bar, row 2: the Module 5 validation paths)
            //
            this.panelActions2.Controls.Add(this.labelActions0);
            this.panelActions2.Controls.Add(this.btnLabEmptyTitle);
            this.panelActions2.Controls.Add(this.btnLabTitleTooLong);
            this.panelActions2.Controls.Add(this.btnLabNoCustomerCategory);
            this.panelActions2.Controls.Add(this.btnLabClosedFutureDue);
            this.panelActions2.Controls.Add(this.btnLabDuplicateNumber);
            this.panelActions2.Controls.Add(this.buttonSlowSave);
            this.panelActions2.Location = new System.Drawing.Point(30, 1232);
            ...
            //
            // buttonSlowSave  (progress path — a toggle armed for the next dialog, including the lab demo buttons)
            //
            this.buttonSlowSave.Location = new System.Drawing.Point(1274, 4);
            ...
            //
            // panelActions3  (bottom bar, row 3: the Module 3+4 browser and editor paths, merged into one row)
            //
            this.panelActions3.Controls.Add(this.labelActions1);
            this.panelActions3.Controls.Add(this.btnAdd);
            this.panelActions3.Controls.Add(this.btnEdit);
            this.panelActions3.Controls.Add(this.buttonSimulateDelete);
            this.panelActions3.Controls.Add(this.buttonBindQuery);
            this.panelActions3.Location = new System.Drawing.Point(30, 1282);
            this.panelActions3.Name = "panelActions3";
            this.panelActions3.Size = new System.Drawing.Size(1980, 44);
            //
            // labelActions1  (reused: this row now carries both the Module 3 and the Module 4 paths)
            //
            ...
            this.labelActions1.Text = "Module 3+4 · editor:";
            ...
            //
            this.buttonSimulateDelete.Location = new System.Drawing.Point(390, 4);
            ...
            //
            this.buttonBindQuery.Location = new System.Drawing.Point(708, 4);
            ...
            //
            // panelActions4  (bottom bar, row 4: the Module 2 model paths)
            //
            ...
            this.panelActions4.Location = new System.Drawing.Point(30, 1332);
            ...
            //
            // panelActions5  (bottom bar, row 5: the Module 1 lifetimes paths)
            //
            ...
            this.panelActions5.Location = new System.Drawing.Point(30, 1382);
            ...
            this.Controls.Add(this.panelBeforeAfter);
            ...
            this.Size = new System.Drawing.Size(2040, 1460);
            this.Text = "Support Desk Data Console — Module 6";
            ...
            this.panelBeforeAfter.ResumeLayout(false);
        ...
        private Wisej.Web.Panel panelBeforeAfter;
        private Wisej.Web.Label labelBeforeAfterTitle;
        private Wisej.Web.Label labelBeforeAfter;
        private Wisej.Web.Label labelLongJob;
        private Wisej.Web.Button btnNaiveSearch;
        private Wisej.Web.Button btnOptimisedSearch;
        private Wisej.Web.Button btnCompare;
        private Wisej.Web.Button btnLongJob;
    }
}
