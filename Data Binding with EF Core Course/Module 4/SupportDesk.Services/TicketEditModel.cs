...
public sealed class TicketEditModel : INotifyPropertyChanged
{
    ...
    /// <summary>Bound to <c>cboCustomer.SelectedValue</c>. Required to save, but nullable here so a fresh "Add ticket" can start with nothing chosen.</summary>
    public int? CustomerId { get => _customerId; set => Set(ref _customerId, value); }

    /// <summary>Bound to <c>cboAgent.SelectedValue</c>. Null means unassigned — a ticket may exist before anyone owns it.</summary>
