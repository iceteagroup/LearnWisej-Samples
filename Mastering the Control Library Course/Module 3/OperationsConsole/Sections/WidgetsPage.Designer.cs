namespace OperationsConsole.Sections
{
    partial class WidgetsPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblBody.Text = "This page is a UserControl hosted in its own tab of the Operations Console shell (Module 3). Module 7 replaces its body with the ratingWidget (Widget + rating.js / rating.css), WidgetEvent to RatingService, CallAsync(\"setSaved\"), theming, capstone.";
