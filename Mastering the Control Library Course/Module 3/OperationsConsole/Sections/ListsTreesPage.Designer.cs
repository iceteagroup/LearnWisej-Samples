namespace OperationsConsole.Sections
{
    partial class ListsTreesPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle.Text = "Lists and Trees";
            ...
            this.lblModule.Text = "PLACEHOLDER · BUILT IN MODULE 4 — LISTS, TREES, REPEATERS, AND HIERARCHICAL DATA";
            ...
            this.lblBody.Text = "This page is a UserControl hosted in its own tab of the Operations Console shell (Module 3). Module 4 replaces its body with the document explorer: lazy TreeView, virtual-mode ListView, shared ImageList, DocumentDetailControl.";
