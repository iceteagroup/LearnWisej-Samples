namespace OperationsConsole.Sections
{
    partial class DashboardPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblModule.Text = "PLACEHOLDER · BUILT IN MODULE 6 — CHARTS, DASHBOARDS, CONTENT, MEDIA, AND DOCUMENTS";
            ...
            this.lblBody.Text = "This page is a UserControl hosted in its own tab of the Operations Console shell (Module 3). Module 6 replaces its body with the dashboard: ChartJS trend, ProgressBar, PdfViewer / HtmlPanel preview, Upload workflow, one RefreshDashboard(model).";
