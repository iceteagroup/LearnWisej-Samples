namespace OperationsConsole.Sections
{
    partial class DataGridViewPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblBody.Text = "This page is a UserControl hosted in its own tab of the Operations Console shell (Module 3). Module 5 replaces its body with the Orders grid: BindingSource + explicit columns, HTML status badge, custom editor, virtual mode with a cache, filter and status strips.";
