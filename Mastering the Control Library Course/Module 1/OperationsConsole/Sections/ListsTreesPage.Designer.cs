namespace OperationsConsole.Sections
{
    partial class ListsTreesPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblBody.Text = "This page is a UserControl swapped into contentPanel by MainPage.Navigate(). Module 4 replaces its body with the document explorer: lazy TreeView, virtual-mode ListView, shared ImageList, DocumentDetailControl.";
