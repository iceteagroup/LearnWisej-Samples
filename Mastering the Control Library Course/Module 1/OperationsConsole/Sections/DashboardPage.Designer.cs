namespace OperationsConsole.Sections
{
    partial class DashboardPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblBody.Text = "This page is a UserControl swapped into contentPanel by MainPage.Navigate(). Module 6 replaces its body with the dashboard: ChartJS trend, ProgressBar, PdfViewer / HtmlPanel preview, Upload workflow, one RefreshDashboard(model).";
