namespace OperationsConsole.Sections
{
    partial class LayoutsPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblModule.Text = "PLACEHOLDER · BUILT IN MODULE 3 — CONTAINERS, LAYOUTS, NAVIGATION, AND REUSE";
            ...
            this.lblBody.Text = "This page is a UserControl swapped into contentPanel by MainPage.Navigate(). Module 3 replaces its body with the real shell (SplitContainer, TabControl, ToolBar, StatusBar) plus the RecordHeader / StatusStrip UserControls and the narrow profile.";
