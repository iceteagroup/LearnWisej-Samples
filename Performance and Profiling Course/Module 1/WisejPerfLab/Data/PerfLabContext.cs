...
namespace WisejPerfLab.Data
{
    ...
    /// </summary>
    /// <remarks>
    /// Module 1–5 deliberately ship <b>without</b> an index on the columns the ticket search filters and
    /// orders by. Module 6 adds it, after the Database profiler tool has shown that the scan is real.
    /// </remarks>
