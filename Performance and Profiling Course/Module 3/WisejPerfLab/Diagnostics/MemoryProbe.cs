...
namespace WisejPerfLab.Diagnostics
{
    ...
    /// <summary>
    /// Takes <see cref="MemorySnapshot"/>s. This file belongs to the Module 4 lab and is here, in the
    /// Module 3 folder, for one reason: the "before" reading has to be taken on the app <b>before</b> the
    /// leak is fixed. Run this module, take snapshot A, open and close the detail form fifty times, take
    /// snapshot B — then compare with the same three buttons in Module 4.
    /// </summary>
