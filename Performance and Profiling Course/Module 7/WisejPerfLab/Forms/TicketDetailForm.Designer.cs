namespace WisejPerfLab.Forms
{
    ...
    {
        // Module 4: the Dispose(bool) override lives in TicketDetailForm.cs, because this form has
        // roots of its own to release. It disposes "components" there, exactly as this file used to.
