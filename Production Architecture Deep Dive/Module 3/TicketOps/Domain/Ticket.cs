...
namespace TicketOps.Domain
{
    ...
    /// Module 3 adds <see cref="Assignee"/>, <see cref="Notes"/> and <see cref="IsEscalated"/> because the
    /// Ticket Workspace shows them (grid columns, detail form, filter chips) — the rules did not change.
    /// </summary>
