...
namespace TicketOps.Domain
{
    ...
    /// The screen shows <see cref="Message"/> verbatim, so it must never contain internals — and in this
    /// module it is already localized: the service resolves the resource key for the session's culture.
